#!/usr/bin/env tsx
/**
 * Script pour exécuter la migration 006_create_time_entries.sql
 * 
 * Usage: pnpm tsx scripts/run-time-entries-migration.ts
 */
...
async function runMigration() {
  console.log('🚀 Démarrage de la migration 006_create_time_entries.sql...\n')
