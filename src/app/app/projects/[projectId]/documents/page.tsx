...
/**
 * Page Documents d'un projet (Internal mode)
    ...
    <div className="flex-1 space-y-6 p-6 md:p-8">
      ...
      <Card className="border-border/50">
        <CardHeader>
          ...
          <CardDescription>
            {t('documentsDescription', { projectName: project.name })}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <EmptyState
            icon={Files}
            title={t('documentsComingSoon')}
            description={t('documentsComingSoonDescription')}
          />
        </CardContent>
      </Card>
    </div>
